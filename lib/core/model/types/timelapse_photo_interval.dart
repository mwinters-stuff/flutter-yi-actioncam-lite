...
class TimeLapsePhotoInterval {
  ...
  static const TimeLapsePhotoInterval Unknown =
      TimeLapsePhotoInterval._('Unknown');
  static const TimeLapsePhotoInterval t_Continue =
      TimeLapsePhotoInterval._('continue');
  static const TimeLapsePhotoInterval t_0_5s =
      TimeLapsePhotoInterval._('0.5 sec');
  static const TimeLapsePhotoInterval t_1s =
      TimeLapsePhotoInterval._('1.0 sec');
  static const TimeLapsePhotoInterval t_2s =
      TimeLapsePhotoInterval._('2.0 sec');
  static const TimeLapsePhotoInterval t_5s =
      TimeLapsePhotoInterval._('5.0 sec');
  static const TimeLapsePhotoInterval t_10s =
      TimeLapsePhotoInterval._('10.0 sec');
  static const TimeLapsePhotoInterval t_30s =
      TimeLapsePhotoInterval._('30.0 sec');
  static const TimeLapsePhotoInterval t_60s =
      TimeLapsePhotoInterval._('60.0 sec');
  static const TimeLapsePhotoInterval t_2m =
      TimeLapsePhotoInterval._('2.0 min');
  static const TimeLapsePhotoInterval t_5m =
      TimeLapsePhotoInterval._('5.0 min');
  static const TimeLapsePhotoInterval t_10m =
      TimeLapsePhotoInterval._('10.0 min');
  static const TimeLapsePhotoInterval t_30m =
      TimeLapsePhotoInterval._('30.0 min');
  static const TimeLapsePhotoInterval t_60m =
      TimeLapsePhotoInterval._('60.0 min');
